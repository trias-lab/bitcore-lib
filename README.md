...
A pure and powerful JavaScript Bitcoin library.This branch add ethereum transaction support. It's used by [bitcore-wallet-service](https://github.com/trias-lab/bitcore-wallet-service).
